...
namespace Onliner.Pages
{
    ...
    {
        public const string CARS_ARTICLE_TEASER = "(//h2//a[text()='Лайфстайл']/parent::h2/parent::header/parent::div//li[@class='b-teasers-2__teaser'])[1]";
        public const string USER_SUPPORT_PAGE = "//a[@href='https://support.onliner.by/']";
        public const string CURRENCY_CONVESRION_PAGE = "//a[@href='https://kurs.onliner.by/']";
        ...
        public void OpenCurrencyConversionPage()
        {
            CurrencyConversionPage.Click();
        }
    }
}
